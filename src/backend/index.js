...
import codeConverterRoute from './codeConverter.route.js';
const app = express();

const PORT = process.env.PORT || 5000;

app.use(cors({ origin:[ 'http://localhost:5174',"https://codecraft-2.netlify.app/",'http://localhost:5173'], credentials: true }));
...
app.use('/convert', codeConverterRoute);
